<template>
    <div class="flex flex-col space-y-4 overflow-x-auto">
        ...
        <table
            class="min-w-full divide-y divide-gray-300 border-1 border-gray-400 rounded shadow"
        >
            ...
            <tbody class="bg-white bg-opacity-90">
                <template v-if="redirects.length">
                    ...
                    >
                        <td
                            class="w-6/12 px-6 py-3 whitespace-nowrap text-sm text-gray-500"
                        >
                        ...
                        <td
                            class="w-3/12 px-6 py-3 whitespace-nowrap text-sm text-blue-500"
                        >
                            <a
                        ...
                        <td class="w-212 px-6 py-3 whitespace-nowrap">
                            <div
                                class="pl-1 text-sm text-indigo-500 font-semibold"
                            >
                        ...
                        <td class="w-1/12 px-6 py-3 whitespace-nowrap text-sm">
                            ...
                            >
                                <div>
                                    <edit-redirect
                                        @editRedirectEvent="getEditedRedirects"
                                        :id="redirect.id"
                                    ></edit-redirect>
                                </div>
                                <div>
                ...
                <tr v-else class="font-normal text-gray-600">
                    <td
                        class="w-12/12 px-6 py-3 whitespace-nowrap text-sm"
                        colspan="4"
                    >
        ...
        <div v-if="meta.total > 25">
            <pagination-component
                :meta="meta"
                v-on:pagination:switched="getRedirects"
            ></pagination-component>
        </div>
    </div>
</template>
